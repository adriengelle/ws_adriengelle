...
- icon: book-open
  icon_pack: fas
  name: Docs
  url: https://datazone.birdlife.org/species/factsheet/baraus-petrel-pterodroma-baraui
- icon: file-audio
  icon_pack: fas
  name: Call
  url: https://xeno-canto.org/309352/embed?darkbg=1'scrolling='no'frameborder='0'width='340'height='220'
---
...
![Breeding distribution of Barau’s Petrel](distrib_Baraus.png)
